...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "509316573", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			...
			mobile: [
				...
				"public/assets/mobile-banner/4.webp",
				"public/assets/mobile-banner/5.webp",
				"public/assets/mobile-banner/6.webp",
			], // 移动横幅图片
		}, // 使用本地横幅图片
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/DonSY1/DonSY1.github.io",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	name: "星秋",
	bio: "TECK OTAKUS SAVE THE WORLD",
	typewriter: {
